...
def plot_scenario3_256_experiments():
    """Plot training progress for Scenario 3 experiments with hidden size 256"""
    # List of experiment files
    experiments = [
        ('exp_80_20_stem_iter0_h256_d0.2_lr0.0001_b16_l2.json', 1),
        ('exp_80_20_stem_iter1_h256_d0.1_lr0.0003_b32_l1.json', 2)
    ]
    ...
    for file_name, exp_num in experiments:
        ...
        plt.title(f'Scenario 3 (80/20) - Experiment {exp_num} Progress', fontsize=12, pad=15)
        plt.xlabel('Epoch')
        plt.ylabel('F1-Score')
        ...
        plt.tight_layout()
        plt.savefig(f'automated_experiments/plots/scenario3_256_experiment_{exp_num}.png', dpi=300, bbox_inches='tight')
        print(f"Plot saved as 'automated_experiments/plots/scenario3_256_experiment_{exp_num}.png'")
        plt.close()

if __name__ == "__main__":
    plot_scenario3_256_experiments() 