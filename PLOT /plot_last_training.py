...
def plot_last_training():
    """Plot the results from the last training session"""
    ...
    plt.tight_layout()
    plt.savefig('plots/last_training_progress.png', dpi=300, bbox_inches='tight')
    print("Plot saved as 'plots/last_training_progress.png'")
