...
def plot_first_experiment():
    """Plot training progress for the first completed experiment"""
    # Load training history
    history_path = 'automated_experiments/results/exp_70_30_stem_iter0_h128_d0.1_lr0.001_b32_l2.json'
    ...
    plt.title('First Experiment - F1-Score Progress', fontsize=12, pad=15)
    plt.xlabel('Epoch')
    plt.ylabel('F1-Score')
    ...
    plt.tight_layout()
    plt.savefig('automated_experiments/plots/first_experiment_progress.png', dpi=300, bbox_inches='tight')
    print("Plot saved as 'automated_experiments/plots/first_experiment_progress.png'")

if __name__ == "__main__":
    plot_first_experiment() 