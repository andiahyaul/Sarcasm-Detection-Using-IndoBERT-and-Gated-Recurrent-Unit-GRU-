...
def plot_scenario3_512_experiment():
    """Plot training progress for Scenario 3 experiment with hidden size 512 (version 1)"""
    # Load training history
    history_path = 'automated_experiments/results/exp_80_20_stem_iter0_h512_d0.2_lr0.0001_b32_l2.json'
    ...
    plt.title('Scenario 3 (80/20) - Hidden Size 512 Progress', fontsize=12, pad=15)
    plt.xlabel('Epoch')
    plt.ylabel('F1-Score')
    ...
    param_text += f"\nBest F1-Score: {results['best_f1']:.4f} (Epoch 3)\n"
    param_text += f"\nFinal Metrics:\n"
    ...
    plt.tight_layout()
    plt.savefig('automated_experiments/plots/scenario3_512_experiment_v1.png', dpi=300, bbox_inches='tight')
    print("Plot saved as 'automated_experiments/plots/scenario3_512_experiment_v1.png'")

if __name__ == "__main__":
    plot_scenario3_512_experiment() 