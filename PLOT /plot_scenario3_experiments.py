...
def plot_experiment(file_path, experiment_number):
    ...
    plt.title(f'Scenario 3 - Experiment {experiment_number} Progress', fontsize=12, pad=15)
    plt.xlabel('Epoch')
    plt.ylabel('F1-Score')
    ...
    plt.tight_layout()
    plt.savefig(f'automated_experiments/plots/scenario3_experiment_{experiment_number}.png', dpi=300, bbox_inches='tight')
    print(f"Plot saved as 'automated_experiments/plots/scenario3_experiment_{experiment_number}.png'")
    plt.close()

def main():
    # List of all experiments in Scenario 3
    experiments = [
        ('exp_80_20_stem_iter0_h512_d0.2_lr0.0001_b16_l1.json', 1),
        ('exp_80_20_stem_iter1_h256_d0.1_lr0.0003_b32_l2.json', 2),
        ('exp_80_20_stem_iter2_h128_d0.3_lr0.001_b16_l1.json', 3),
        ('exp_80_20_stem_iter3_h512_d0.2_lr0.0003_b32_l2.json', 4),
        ('exp_80_20_stem_iter4_h256_d0.1_lr0.001_b16_l1.json', 5)
    ]
    ...
    for file_name, exp_num in experiments:
        try:
            ...
            print(f"Results file not found for experiment {exp_num} - training may still be in progress")
