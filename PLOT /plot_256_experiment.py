...
def plot_256_experiment():
    """Plot training progress for the experiment with hidden size 256"""
    # Load training history
    history_path = 'automated_experiments/results/exp_70_30_stem_iter0_h256_d0.3_lr0.0003_b32_l1.json'
    ...
    plt.title('Hidden Size 256 - F1-Score Progress', fontsize=12, pad=15)
    plt.xlabel('Epoch')
    plt.ylabel('F1-Score')
    ...
    plt.tight_layout()
    plt.savefig('automated_experiments/plots/hidden_size_256_progress.png', dpi=300, bbox_inches='tight')
    print("Plot saved as 'automated_experiments/plots/hidden_size_256_progress.png'")
