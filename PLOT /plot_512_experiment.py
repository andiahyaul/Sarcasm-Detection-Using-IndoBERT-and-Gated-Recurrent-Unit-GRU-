...
def plot_512_experiment():
    """Plot training progress for the experiment with hidden size 512"""
    # Load training history
    history_path = 'automated_experiments/results/exp_70_30_stem_iter1_h512_d0.3_lr0.0001_b16_l2.json'
    ...
    plt.title('Hidden Size 512 - F1-Score Progress', fontsize=12, pad=15)
    plt.xlabel('Epoch')
    plt.ylabel('F1-Score')
    ...
    plt.tight_layout()
    plt.savefig('automated_experiments/plots/hidden_size_512_progress.png', dpi=300, bbox_inches='tight')
    print("Plot saved as 'automated_experiments/plots/hidden_size_512_progress.png'")
