...
def plot_scenario3_progress():
    """Plot training progress for scenario 3 (70-30 split, without stemming)"""
    # Load training history
    history_path = 'models/saved_models/split_70-30_without_stemming_dim_768/training_history.json'
    ...
    plt.title('Scenario 3 - F1-Score Progress (70-30 split, without stemming)', fontsize=12, pad=15)
    plt.xlabel('Epoch')
    plt.ylabel('F1-Score')
    ...
    param_text = "Scenario 3 Best Parameters:\n\n"
    ...
    plt.tight_layout()
    plt.savefig('plots/scenario_3_progress.png', dpi=300, bbox_inches='tight')
    print("Plot saved as 'plots/scenario_3_progress.png'")

if __name__ == "__main__":
    plot_scenario3_progress() 